              ...
              body: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Container(
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: AppColors.borderColor, width: 2.sp)),
                          // radius: 90,
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: profile.profileData.data!.image !=
                                                null ||
                                            profile.profileData.data!.image !=
                                                ""
                                        ? NetworkImage(
                                            profile.profileData.data!.image!)
                                        : const AssetImage(
                                                AppAssets.profileUserIcon)
                                            as ImageProvider,
                                    fit: BoxFit.fill)),
                          ),
                        ),
                    ...
                    addHeight(20.h),
                    addBoldTxt(profile.profileData.data!.name ?? "",
                        color: AppColors.primaryColor, fontSize: 18.sp),
                    addHeight(10.h),
                    addRegularTxt(profile.profileData.data!.email ?? "",
                            ...
                            children: [
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    addWidth(20.h),
                                    addRegularTxt('General Settings',
                                        fontSize: 14.sp,
                              ...
                              subScreen("Purchased Items ", () {
                                ...
                                final yourItemController =
                                    Get.find<YourItemsController>();
                                yourItemController.selectedTabIndex = 1;
                                yourItemController.controller.animateTo(1);
                                controller.update();
                              }),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              subScreen("Terms & Conditions", () {
                                Get.toNamed(AppRoutes.cmsPagesScreen,
                                    arguments: {
                                      'cmsPagesTitle': 'Terms & Conditions',
