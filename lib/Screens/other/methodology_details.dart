...
class MethodologyDetailScreen extends StatefulWidget {
  ...
  @override
  State<MethodologyDetailScreen> createState() => _MethodologyDetailScreenState();
}
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            addHeight(20),
            addHeadingTxt('Methodology',fontSize: 20,fontWeight: FontWeight.w600,color: AppColors.primaryColor),
            addHeight(20),
